...
const PRODUCTS = [
...

  {
    ...
    sizes: '0–18 mois',
    photos: [
      P + 'Turbulette%201.png',
      P + 'turbulette%20brod%C3%A9e%202%201.png',
    ],
    description: [
...

  {
    ...
    sizes: null,
    photos: [
      P + '552785966_17970778961946309_8562487617140048474_n.%201.png',
      P + '569387996_17974343630946309_5089851895889682679_n.%201.png',
      P + 'Babynest%20%282%29.jfif',
      P + 'Babynest%20%283%29.jfif',
      P + 'Babynest%20%284%29.jfif',
    ],
    description: [
...

  {
    ...
    sizes: null,
    photos: [
      P + 'sac%20%C3%A0%20dos%20cr%C3%A8che%206.png',
      P + 'sac%20%C3%A0%20dos%20cr%C3%A8che%202%201.png',
      P + 'sac%20%C3%A0%20dos%20cr%C3%A8che%203%201.png',
      P + 'sac%20%C3%A0%20dos%20cr%C3%A8che%205%201.png',
    ],
    description: [
...

  {
    ...
    sizes: null,
    photos: [
      P + '574750256_17975969078946309_2476281317568177951_n.%201.png',
      P + '586669161_17977583036946309_1278746929384982568_n.%201.png',
      P + 'Prot%C3%A8ge%20carnet%20de%20sant%C3%A9%201.png',
    ],
    description: [
...

  {
    ...
    sizes: null,
    photos: [
      P + 'Doudou%20lapin%202.jfif',
      P + 'Doudou%20lapin%201.jfif',
      P + 'Doudou%20lapin%20%283%29.jfif',
      P + 'Doudou%20lapin%20%285%29.jfif',
      P + 'Doudou%20lapin%20%2812%29.jfif',
    ],
    description: [
...

  {
    ...
    sizes: null,
    photos: [
      P + 'Pochette%20%2B%20coton%209%201.png',
      P + 'Pochette%20%2B%20coton%201%201.png',
      P + 'Pochette%20%2B%20coton%205%201.png',
      P + 'Pochette%20%2B%20coton%206%201.png',
    ],
    description: [
...

  {
    ...
    sizes: null,
    photos: [
      P + 'Serviette%20de%20t%C3%AAte.jfif',
      P + 'Serviette%20de%20t%C3%AAte%201.jfif',
      P + 'Serviette%20de%20t%C3%AAte%202.jfif',
    ],
    description: [
...

  {
    ...
    sizes: null,
    photos: [
      P + '552950121_17970917090946309_2205476163409626417_n.%201.png',
      P + 'Pochette%20pour%20soignants%203%201.png',
      P + 'Pochette%20pour%20soignants%204%201.png',
      P + 'Pochette%20pour%20soignants%205%201.png',
      P + 'Pochette%20infiermiere%206.jfif',
      P + 'Pochette%20infiermiere%2011.jfif',
    ],
    description: [
...

  {
    ...
    sizes: null,
    photos: [
      P + 'Trousse%20agenda%20%281%29.jfif',
      P + 'Trousse%20agenda%201.png',
      P + 'Trousse%20agenda%20%288%29.jfif',
      P + 'Trousse%20agenda%20%285%29.jfif',
    ],
    description: [
...

  {
    ...
    sizes: null,
    photos: [
      P + 'Marque%20page%201%201.png',
      P + 'Marque%20page%203%201.png',
    ],
    description: [
...

  {
    ...
    sizes: null,
    photos: [
      P + 'georges%202%201.png',
      P + 'georges%203%201.png',
      P + 'georges%204%201.png',
      P + 'georges%205%201.png',
    ],
    description: [
...

  {
    ...
    sizes: null,
    photos: [
      P + 'Banane%202%201.png',
      P + 'Bananes%20livr%C3%A9es%20pour%20No%C3%ABl%20%F0%9F%8E%85%201.png',
      P + 'Bananes%20livr%C3%A9es%20pour%20No%C3%ABl%20%F0%9F%8E%85%20%284%29%201.png',
      P + 'Sac%20banane%201.png',
    ],
    description: [
...

  {
    ...
    photos: [
      P + 'Sac%20a%20langer.jfif',
      P + 'Sac%20a%20langer%202.jfif',
      P + 'Sac%20a%20langer%20(1).jfif',
      P + 'Sac%20a%20langer%20(2).jfif',
      P + 'Sac%20a%20langer%20(3).jfif',
      P + 'Sac%20a%20langer%20(4).jfif',
      P + 'Sac%20a%20langer%20(5).jfif',
      P + 'Sac%20a%20langer%20(6).jfif',
      P + 'Tapis%20a%20langer.jfif',
      P + 'Tapis%20a%20langer%201.jfif',
      P + 'Tapis%20a%20langer%202.jfif',
      P + 'Tapis%20a%20langer%20(2).jfif',
      P + 'Tapis%20a%20langer%20(4).jfif',
    ],
    description: [
...

  {
    ...
    price: '10',
    photos: [
      P + 'bavoir%20de%20maternelle.jfif',
      P + 'bavoir%20de%20maternelle%20(1).jfif',
      P + 'bavoir%20de%20maternelle%20(2).jfif',
    ],
    description: [
...

  {
    ...
    price: '40',
    photos: [
      P + 'Trousse%20de%20toilette%20(1).jfif',
      P + 'Trousse%20de%20toilette%20(2).jfif',
      P + 'Trousse%20de%20toilette%20(3).jfif',
      P + 'Trousse%20de%20toilette%20(4).jfif',
      P + 'Trousse%20de%20toilette%20(5).jfif',
      P + 'Trousse%20de%20toilette%20(6).jfif',
    ],
    description: [
